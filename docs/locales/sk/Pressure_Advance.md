...
Tento dokument poskytuje informácie o ladení konfiguračnej premennej „postup tlaku“ pre konkrétnu trysku a filament. Funkcia postupu tlaku môže byť užitočná pri znižovaní výtoku. Viac informácií o implementácii postupu tlaku nájdete v dokumente [kinematika](Kinematics.md).
