...
Bu belge Klipper'in faz ayarlı step motor endstop sistemini açıklamaktadır. Bu işlev, geleneksel endstop anahtarlarının doğruluğunu artırabilir. Çalışma zamanı konfigürasyonuna sahip bir Trinamic step motor sürücüsü kullanıldığında kullanışlıdır.
