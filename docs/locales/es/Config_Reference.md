...
Las descripciones de este documento están formateadas de manera que sea posible copiarlas y pegarlas en un archivo de configuración de la impresora. Consulte el [documento de instalación](Installation.md) para obtener información sobre cómo configurar Klipper y elegir un archivo de configuración inicial.

## Micro-controller configuration

### Formato de los nombres de los pines del microcontrolador

Muchas opciones de configuración requieren el nombre de un pin del microcontrolador. Klipper utiliza los nombres de hardware para estos pines, por ejemplo, «PA4».

Los nombres de los pines pueden ir precedidos de «!» para indicar que se debe utilizar una polaridad inversa (por ejemplo, activación en bajo en lugar de en alto).
