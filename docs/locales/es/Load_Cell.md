...
Este documento describe la compatibilidad de Klipper con las células de carga. La funcionalidad básica de las células de carga se puede utilizar para leer datos de fuerza y pesar elementos como filamentos. Un sensor de fuerza calibrado es una parte importante de una sonda basada en una célula de carga.

## Documentación relacionada

* [load_cell Config Reference](Config_Reference.md#load_cell)
* [load_cell G-Code Commands](G-Codes.md#load_cell)
* [Referencia de estado de la célula de carga](Status_Reference.md#load_cell)
