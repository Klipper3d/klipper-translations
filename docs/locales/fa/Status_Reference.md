...
این سند مرجعی برای اطلاعات وضعیت پرینتر در Klipper است که در ماکروها (Command_Templates)، فیلدهای نمایش (Config_Reference) و از طریق سرور API (API_Server) در دسترس می‌باشد.
