...
تسطیح تخت (که گاهی اوقات به آن "ترمال کردن بستر" نیز گفته می شود) برای چاپ با کیفیت بالا بسیار مهم است. اگر یک تخت به درستی "تراز" نباشد، می تواند منجر به چسبندگی ضعیف تخت، "تاب برداشتن" و مشکلات ظریف در سراسر چاپ شود. این سند به عنوان راهنمای انجام تسطیح بستر در کلیپر عمل می کند.
