...
این سند، تغییرات نرم‌افزاری اخیر در فایل پیکربندی را که با نسخه‌های قبلی سازگار نیستند، پوشش می‌دهد. بهتر است هنگام ارتقاء نرم‌افزار Klipper، این سند را مرور کنید.
