...
Este documento contém diretrizes para contribuir com um exemplo de configuração do Klipper para o repositório github do Klipper (localizado no [diretório de configuração](../config/)).
