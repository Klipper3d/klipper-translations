...
O sensor de temperatura combinado é um sensor de temperatura virtual baseado em vários outros sensores. Este sensor pode ser utilizado com extrusoras, heater_generic e heater beds.
