...
В этом документе описывает интерфейс прикладного программирования (API) Klipper. Этот интерфейс позволяет внешним приложениям запрашивать и контролировать программное обеспечение хоста Klipper.
