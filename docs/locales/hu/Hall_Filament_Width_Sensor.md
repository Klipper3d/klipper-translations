...
A Hall nyomtatószál szélesség érzékelő használatához olvassa el a [Config Reference](Config_Reference.md#hall_filament_width_sensor) és a [G-Code dokumentáció](G-Codes.md#hall_filament_width_sensor) részt.
