...
`{"id": 123, "result": {"state_message": "அச்சுப்பொறி தயாராக உள்ளது", "klipper_path": "/home/pi/klipper", "config_file": "/home/pi/printer.cfg", "software_version": "v0.8.0-823-g883b1cb6", "hostname": "octopi", "cpu_info": "4 core ARMv7 செயலி rev 4 (v7l)", "state": "ready", "python_path": "/home/pi/klippy-env/bin/python", "log_file": "/tmp/klippy.log"}}`

ஒவ்வொரு கோரிக்கையும் ஒரு JSON அகராதியாக இருக்க வேண்டும். (இந்த ஆவணம் "JSON object" ஐ விவரிக்கப் பைதான் வார்த்தையான "அகராதி" யைப் பயன்படுத்துகிறது - `{}` இல் உள்ள விசை/மதிப்பு ஜோடிகளின் மேப்பிங்.)
...
ஒரு கோரிக்கையைச் செயலாக்கும்போது பிழை ஏற்பட்டால், பதில் செய்தியில் "முடிவு" புலத்திற்குப் பதிலாக "பிழை" புலம் இருக்கும். எடுத்துக்காட்டாக, கோரிக்கை: `{"id": 123, "method": "gcode/script", "params": {"script": "G1 X200"}}` என்பது `{"id": 123, "error": {"message": "முதலில் முகப்பு அச்சில் இருக்க வேண்டும்: 200.000 0.000 0.000 [0.000]", "error": "WebRequestError"}}` போன்ற பிழை பதிலுக்கு வழிவகுக்கும்
...
ஒரு கோரிக்கை இப்படி இருக்கலாம்: `{"id": 123, "method":"motion_report/dump_stepper", "params": {"name": "stepper_x", "response_template": {}}}` மேலும் இது இவ்வாறு திரும்பலாம்: `{"id": 123, "result": {"header": ["interval", "count", "add"]}}` மேலும் பின்னர் `{"params": {"first_clock": 179601081, "first_time": 8.98, "first_position": 0, "last_clock": 219686097, "last_time": 10.984, "data": [[179601081, 1, 0], [29573, 2, -8685], [16230, 4, -1525], [10559, 6, -160], [10000, 976, 0], [10000, 1000, 0], [10000, 1000, 0], [10000, 1000, 0], [9855, 5, 187], [11632, 4, 1534], [20756, 2, 9442]]}}`
...
[கோண சென்சார் தரவு](config_reference.md#கோணம்) க்கு குழுசேர இந்த இறுதிப்புள்ளி பயன்படுத்தப்படுகிறது. இந்த குறைந்த-நிலை இயக்கப் புதுப்பிப்புகளைப் பெறுவது கண்டறியும் மற்றும் பிழைத்திருத்த நோக்கங்களுக்குப் பயனுள்ளதாக இருக்கும். இந்த இறுதிப்புள்ளியைப் பயன்படுத்துவது கிளிப்பரின் கணினி சுமையை அதிகரிக்கக்கூடும்.
...
### சுமை_செல்/டம்ப்_ஃபோர்ஸ்

இந்த எண்ட்பாயிண்ட், ஒரு load_cell ஆல் உருவாக்கப்படும் தரவை கட்டாயப்படுத்த சந்தா செலுத்தப் பயன்படுகிறது. இந்த எண்ட்பாயிண்டைப் பயன்படுத்துவது Klipper இன் கணினி சுமையை அதிகரிக்கக்கூடும்.

ஒரு கோரிக்கை `{"id": 123, "method":"load_cell/dump_force", "params": {"sensor": "load_cell", "response_template": {}}}` மற்றும் `{"id": 123,"result":{"header":["time", "force (g)", "counts", "tare_counts"]}}` எனத் தோன்றலாம், பின்னர் `{"params":{"data":[[3292.432935, 40.65, 562534, -234467]]}}` போன்ற ஒத்திசைவற்ற செய்திகளை உருவாக்கக்கூடும்
...
### இடைநிறுத்தம்_மீண்டும் தொடங்கு/மீண்டும் தொடங்கு
