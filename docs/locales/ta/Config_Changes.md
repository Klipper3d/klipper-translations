...
20231207: `[printer]` config பிரிவில் உள்ள பல ஆவணப்படுத்தப்படாத config அளவுருக்கள் (buffer_time_low, buffer_time_high, buffer_time_start, மற்றும் move_flush_time parameters) அகற்றப்பட்டன.
...
20220330: நியோபிக்சல் மற்றும் டாட்ஸ்டார் தொகுதிகளுக்கான `printer.neopixel.color_data` நிலைத் தகவலின் வடிவம் மாறிவிட்டது. இந்தத் தகவல் இப்போது வண்ணப் பட்டியல்களின் பட்டியலாகச் சேமிக்கப்படுகிறது (அகராதிகளின் பட்டியலுக்குப் பதிலாக). விவரங்களுக்கு [நிலை குறிப்பு](Status_Reference.md#led) ஐப் பார்க்கவும்.
