...
மெஷ் அளவுத்திருத்தத்திற்கு முன், உங்கள் ப்ரோபின் Z-ஆஃப்செட் அளவீடு செய்யப்பட்டுள்ளதா என்பதை நீங்கள் உறுதி செய்ய வேண்டும். Z ஹோமிங்கிற்கு எண்ட்ஸ்டாப்பைப் பயன்படுத்தினால், அதுவும் அளவீடு செய்யப்பட வேண்டும். மேலும் தகவலுக்கு [Manual Level](Manual_Level.md) இல் [Probe Calibrate](Probe_Calibrate.md) மற்றும் Z_ENDSTOP_CALIBRATE ஐப் பார்க்கவும்.
...
![பெட்மெஷ்_ரெக்ட்_பேசிக்](img/bedmesh_rect_basic.svg)
...
![பெட்மெஷ்_ரவுண்ட்_பேசிக்](img/bedmesh_round_basic.svg)
...
![பெட்மெஷ்_இன்டர்போலேட்டட்](img/bedmesh_interpolated.svg)
...
பல ஆய்வுகள் "சறுக்கலுக்கு" ஆளாகின்றன, அதாவது: வெப்பம் அல்லது குறுக்கீட்டால் அறிமுகப்படுத்தப்படும் ஆய்வுகளில் உள்ள துல்லியமின்மை. இது ஆய்வின் z-ஆஃப்செட்டைக் கணக்கிடுவதை சவாலானதாக மாற்றும், குறிப்பாக வெவ்வேறு படுக்கை வெப்பநிலைகளில். எனவே, சில அச்சுப்பொறிகள் Z அச்சை ஹோம் செய்வதற்கு ஒரு எண்ட்ஸ்டாப்பையும், மெஷை அளவீடு செய்வதற்கு ஒரு ப்ரோப்பையும் பயன்படுத்துகின்றன. இந்த உள்ளமைவில் (X, Y) `குறிப்பு நிலை` பூஜ்ஜிய சரிசெய்தலைப் பயன்படுத்தும் வகையில் மெஷை ஆஃப்செட் செய்ய முடியும். `குறிப்பு நிலை` என்பது படுக்கையில் [Z_ENDSTOP_CALIBRATE](./Manual_Level.md#calibrating-a-z-endstop) காகித சோதனை செய்யப்படும் இடமாக இருக்க வேண்டும். இந்த ஒருங்கிணைப்பைக் குறிப்பிடுவதற்கு bed_mesh தொகுதி `zero_reference_position` விருப்பத்தை வழங்குகிறது:
...
`zero_reference_position` ஐப் பயன்படுத்த, `relative_reference_index` விருப்பத்தைப் பயன்படுத்தும் தற்போதைய உள்ளமைவுகளைப் புதுப்பிக்க வேண்டும். [BED_MESH_OUTPUT PGP=1](#output) gcode கட்டளைக்கான பதில் குறியீட்டுடன் தொடர்புடைய (X, Y) ஆயத்தொலைவை உள்ளடக்கும்; இந்த நிலையை `zero_reference_position` க்கான மதிப்பாகப் பயன்படுத்தலாம். வெளியீடு பின்வருவனவற்றைப் போலவே இருக்கும்:
...
![பெட்மெஷ்_இன்டர்போலேட்டட்](img/bedmesh_faulty_regions.svg)
...
![அடாப்டிவ்_பெட்மெஷ்](img/adaptive_bed_mesh.svg)
...
- `அடாப்டிவ்_மார்சின்` * இயல்புநிலை மதிப்பு: 0 * விளிம்பு (மிமீ) வரையறுக்கப்பட்ட பொருள்களால் பயன்படுத்தப்படும் படுக்கையின் பகுதியைச் சேர்க்க. கீழேயுள்ள வரைபடம் 5 மிமீ `அடாப்டிவ்_மார்சின்` உடன் தழுவிய படுக்கை கண்ணி பகுதியைக் காட்டுகிறது. தழுவிய கண்ணி பகுதி (பச்சை நிறத்தில் பகுதி) பயன்படுத்தப்பட்ட படுக்கை பகுதி (நீல நிறத்தில் பகுதி) மற்றும் வரையறுக்கப்பட்ட விளிம்பு என கணக்கிடப்படுகிறது.
   ...
   ![தகவமைப்பு_பெட்மெஷ்_விளிம்பு](img/adaptive_bed_mesh_margin.svg)
...
[Eddy Current Probe](./Eddy_Probe.md) போன்ற சில ஆய்வுகள், படுக்கையின் மேற்பரப்பை "ஸ்கேன்" செய்யும் திறன் கொண்டவை. அதாவது, இந்த ஆய்வுகள் மாதிரிகளுக்கு இடையில் கருவியைத் தூக்காமல் ஒரு கண்ணியை மாதிரியாக எடுக்க முடியும். ஸ்கேனிங் பயன்முறையைச் செயல்படுத்த, `METHOD=scan` அல்லது `METHOD=rapid_scan` ஆய்வு அளவுருவை `BED_MESH_CALIBRATE` gcode கட்டளையில் அனுப்ப வேண்டும்.
...
கட்டமைப்பின் அடிப்படையில் சிறந்த முடிவை வழங்குவதற்காகப் பயண பாதையை மேம்படுத்தப் படுக்கை கண்ணி முயற்சிக்கும். மாதிரிகள் சேகரிக்கும்போது தவறான பகுதிகளைத் தவிர்ப்பது மற்றும் திசையை மாற்றும்போது கண்ணி "ஓவர்சூட்டிங்" ஆகியவை இதில் அடங்கும். இந்த ஓவர்சூட் ஒரு கண்ணி விளிம்புகளில் மாதிரியை மேம்படுத்துகிறது, இருப்பினும் அந்தக் கண்ணி வெளியே பயணிக்க அனுமதிக்கும் வகையில் கண்ணி கட்டமைக்கப்பட வேண்டும்.
...
`BED_MESH_CALIBRATE PROFILE=<name>METHOD=[கையேடு | தானியங்கி | ஸ்கேன் | விரைவான ஸ்கேன்] \ [<probe_parameter>=<value>] [<mesh_parameter>=<value>] [ADAPTIVE=[0|1] \ [ADAPTIVE_MARGIN=<value>]` *இயல்புநிலை சுயவிவரம்: இயல்புநிலை* *இயல்புநிலை முறை: ஒரு ஆய்வு கண்டறியப்பட்டால் தானியங்கி, இல்லையெனில் கையேடு* *இயல்புநிலை தகவமைப்பு: 0* *இயல்புநிலை தகவமைப்பு விளிம்பு: 0*
...
`BED_MESH_OFFSET [X=<மதிப்பு>] [Y=<மதிப்பு>] [ZFADE=<மதிப்பு>]`
...
ஒரு ZFADE ஆஃப்செட் நேரடியாகக் கூடுதல் சரிசெய்தலைப் *பயன்படுத்தாது* என்பதை நினைவில் கொள்ளவும். `gcode offset`-ஐ ஈடுசெய்ய இது நோக்கமாகக் கொண்டுள்ளது [மெஷ் ஃபேட்](#mesh-fade) இயக்கப்பட்டிருக்கும்போது. எடுத்துக்காட்டாக, ஒரு இரண்டாம் நிலை எக்ஸ்ட்ரூடர் முதன்மையை விட அதிகமாக இருந்தால் மற்றும் எதிர்மறை gcode ஆஃப்செட் தேவைப்பட்டால், அதாவது: `SET_GCODE_OFFSET Z=-.2`, அதை `bed_mesh`-இல் `BED_MESH_OFFSET ZFADE=.2` உடன் கணக்கிடலாம்.
...
- `உள்ளீடு`: உள்ளீட்டு மூலத்திற்கு ஒரு பாதை அல்லது முகவரி ஐக் கொண்ட தேவையான நிலை உரையாடல். இது பின்வருவனவற்றில் ஒன்றாக இருக்க வேண்டும்:
   ...
   - `graph_mesh.py dump <input>` ஆல் உருவாக்கப்பட்ட json கோப்பிற்கான பாதை
...
`graph_mesh.py` கருவி, [bed_mesh/dump_mesh](#dumping-mesh-data) API ஆல் வழங்கப்பட்ட தரவின் பகுப்பாய்வைச் செய்யவும் பயன்படுத்தப்படலாம்:
...
- நிலையான ஆய்வுப் பாதை மற்றும் விரைவான ஸ்கேன் பாதை இரண்டிற்கும் ஒரு "பின்தொடர்தல்" சோதனை. ஆய்வு நடைமுறையின்போது ஒரே நிலைக்கு ஒன்றுக்கு மேற்பட்ட முறை நகர்வதை பின்தொடர்தல் என்று வரையறுக்கலாம். ஒரு நிலையான ஆய்வு போது பின்தொடர்தல் ஒருபோதும் நிகழக் கூடாது. ஒரு ஆய்வு இடத்தை நெருங்கும்போதோ அல்லது வெளியேறும்போதோ ஒரு தவறான பகுதிக்குள் நுழைவதைத் தவிர்க்கும் முயற்சியில், விரைவான ஸ்கேன் போது தவறான பகுதிகள் *பின்தொடர்தலுக்கு* வழிவகுக்கும், இருப்பினும், வேறுவிதமாக ஒருபோதும் நிகழக் கூடாது.
