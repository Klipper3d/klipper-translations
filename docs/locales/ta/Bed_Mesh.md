...
மெச் அளவுத்திருத்தத்திற்கு முன், உங்கள் ஆய்வின் சட்-ஈடுசெய் அளவீடு செய்யப்பட்டுள்ளதா என்பதை நீங்கள் உறுதி செய்ய வேண்டும். சட வீட்டிற்கு முடிவுபுள்ளி பயன்படுத்தினால், அதுவும் அளவீடு செய்யப்பட வேண்டும். மேலும் தகவலுக்குக் [கையேடு நிலை](Manual_Level.md) இல் [ஆய்வு அளவீடு](Probe_Calibrate.md) மற்றும் Z_ENDSTOP_CALIBRATE ஐப் பார்க்கவும்.
...
![படுக்கைவலை_கட்டம்_அடிப்படை](img/bedmesh_rect_basic.svg)
...
![படுக்கைவலை_வட்டம்_அடிப்படை](img/bedmesh_round_basic.svg)
...
![படுக்கைவலை_இடைச்செருகப்பட்டது](img/bedmesh_interpolated.svg)
...
![படுக்கைவலை_இடைச்செருகப்பட்டது](img/bedmesh_faulty_regions.svg)
...
![தகவமைப்பு படுக்கை வலை](img/adaptive_bed_mesh.svg)
...
- `அடாப்டிவ்_மார்சின்` * இயல்புநிலை மதிப்பு: 0 * விளிம்பு (மிமீ) வரையறுக்கப்பட்ட பொருள்களால் பயன்படுத்தப்படும் படுக்கையின் பகுதியைச் சேர்க்க. கீழேயுள்ள வரைபடம் 5 மிமீ `அடாப்டிவ்_மார்சின்` உடன் தழுவிய படுக்கை கண்ணி பகுதியைக் காட்டுகிறது. தழுவிய கண்ணி பகுதி (பச்சை நிறத்தில் பகுதி) பயன்படுத்தப்பட்ட படுக்கை பகுதி (நீல நிறத்தில் பகுதி) மற்றும் வரையறுக்கப்பட்ட விளிம்பு என கணக்கிடப்படுகிறது.
   ...
   ![தகவமைப்பு படுக்கை வளைய_விளிம்பு](img/adaptive_bed_mesh_margin.svg)
...
`BED_MESH_CALIBRATE PROFILE=<பெயர்> METHOD=[manual | automatic | scan | rapid_scan] \ [<probe_parameter>=<மதிப்பு>] [<mesh_parameter>=<value>] [ADAPTIVE=[0|1] \ [ADAPTIVE_MARGIN=<மதிப்பு>]` *இயல்புநிலை சுயவிவரம்: இயல்புநிலை* *இயல்புநிலை முறை: தானியங்கி என்றால் ஒரு ஆய்வு கண்டறியப்பட்டது, இல்லையெனில் கையேடு*  *இயல்புநிலை தகவமைப்பு: 0*  *இயல்புநிலை தகவமைப்பு விளிம்பு: 0*
...
ஒரு ZFADE ஆஃப்செட் நேரடியாகக் கூடுதல் சரிசெய்தலைப் *பயன்படுத்தாது* என்பதை நினைவில் கொள்ளவும். [மெஷ் ஃபேட்](#mesh-fade) இயக்கப்பட்டிருக்கும்போது `gcode ஆஃப்செட்`-ஐ ஈடுசெய்ய இது நோக்கமாகக் கொண்டுள்ளது. எடுத்துக்காட்டாக, ஒரு இரண்டாம் நிலை எக்ஸ்ட்ரூடர் முதன்மையை விட அதிகமாக இருந்தால் மற்றும் எதிர்மறை gcode ஆஃப்செட் தேவைப்பட்டால், அதாவது: `SET_GCODE_OFFSET Z=-.2`, அதை `bed_mesh`-இல் `BED_MESH_OFFSET ZFADE=.2` உடன் கணக்கிடலாம்.
...
- `உள்ளீடு`: உள்ளீட்டு மூலத்திற்கு ஒரு பாதை அல்லது முகவரி ஐக் கொண்ட தேவையான நிலை உரையாடல். இது பின்வருவனவற்றில் ஒன்றாக இருக்க வேண்டும்:
   ...
   - `graph_mesh.py dump <input>` ஆல் தயாரிக்கப்பட்ட சாதொபொகு கோப்பிற்கான பாதை
...
[BED_MESH/DUMB_MESH](#dumping-mesh-data) பநிஇ ஆல் வழங்கப்பட்ட தரவுகளில் ஒரு பகுப்பாய்வைச் செய்ய `Mapric_mesh.py` கருவி பயன்படுத்தப்படலாம்:
...
- நிலையான ஆய்வுப் பாதை மற்றும் விரைவான ச்கேன் பாதை இரண்டையும் ஒரு "பின்னடைவு" சரிபார்க்கவும். ஆய்வு நடைமுறையின்போது ஒரு முறைக்கு மேல் அதே நிலைக்கு நகர்வதை பின்னடைவு வரையறுக்கலாம். ஒரு நிலையான ஆய்வின்போது பின்வாங்குவது ஒருபோதும் ஏற்படக் கூடாது. தவறான பகுதிகள் விரைவான ச்கேன் போது *பின்வாங்குவதற்கு* வழிவகுக்கும், இது ஒரு ஆய்வு இடத்தை நெருங்கும்போது அல்லது வெளியேறும்போது தவறான பகுதிக்குள் நுழைவதைத் தவிர்ப்பதற்கான முயற்சியில், இருப்பினும் ஒருபோதும் ஏற்படக் கூடாது.
