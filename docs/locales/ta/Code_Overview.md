...
மைக்ரோ-கன்ட்ரோலர் குறியீட்டின் செயல்பாடு கட்டமைப்பு குறிப்பிட்ட குறியீட்டில் (எ.கா., ** SRC/AVR/MAIN.C **) தொடங்குகிறது, இது இறுதியில் ** SRC/Sall.C ** இல் அமைந்துள்ள Sape_Main () ஐ அழைக்கிறது. Seplow_Init () மேக்ரோவுடன் குறிக்கப்பட்ட அனைத்து செயல்பாடுகளையும் இயக்குவதன் மூலம் Sapel_main () குறியீடு தொடங்குகிறது. இது டெக்_ டாச்க் () மேக்ரோவுடன் குறிக்கப்பட்ட அனைத்து செயல்பாடுகளையும் மறுநிகழ்வு இயக்குகிறது.

** src/command.c ** இல் அமைந்துள்ள கட்டளை_டிச்பாட்ச் () முக்கிய பணி செயல்பாடுகளில் ஒன்று. இந்தச் செயல்பாடு போர்டு குறிப்பிட்ட உள்ளீடு/வெளியீட்டுக் குறியீட்டிலிருந்து அழைக்கப்படுகிறது (எ.கா. உள்ளீட்டு ச்ட்ரீமில். கட்டளை செயல்பாடுகள் pect_command () மேக்ரோவைப் பயன்படுத்தி அறிவிக்கப்படுகின்றன (மேலும் தகவலுக்கு [நெறிமுறை](Protocol.md) ஆவணத்தைப் பார்க்கவும்).
...
கிளிப்பி ஓச்டுக்கு "சி 1" கட்டளை அனுப்பப்படும்போது ஒரு பொதுவான அச்சுப்பொறி இயக்கம் தொடங்குகிறது, மேலும் மைக்ரோ-கன்ட்ரோலரில் தொடர்புடைய படி பருப்பு வகைகள் தயாரிக்கப்படும்போது அது நிறைவு செய்கிறது. இந்தப் பிரிவு ஒரு பொதுவான நகர்வு கட்டளையின் குறியீடு ஓட்டத்தைக் கோடிட்டுக் காட்டுகிறது. [இயக்கவியல்](Kinematics.md) ஆவணம் நகர்வுகளின் இயக்கவியல் பற்றிய கூடுதல் தகவல்களை வழங்குகிறது.
...
* Toolhead வகுப்பு (toolhead.py இல்) "look-ahead" ஐக் கையாளுகிறது மற்றும் அச்சிடும் செயல்களின் நேரத்தைக் கண்காணிக்கிறது. ஒரு நகர்வுக்கான முக்கிய குறியீட்டுப் பாதை: `ToolHead.move() -> LookAheadQueue.add_move() -> LookAheadQueue.flush() -> Move.set_junction() -> ToolHead._process_moves()`.
...
* ஒவ்வொரு ச்டெப்பருக்கும் படி நேரங்களை உருவாக்கக் கிளிப்பர் ஒரு [மறுசீரமைப்பு தீர்வி](https://en.wikipedia.org/wiki/root-finding_algorithm) ஐப் பயன்படுத்துகிறார். செயல்திறன் காரணங்களுக்காக, ச்டெப்பர் துடிப்பு நேரங்கள் சி குறியீட்டில் உருவாக்கப்படுகின்றன. நகர்வுகள் முதலில் "ட்ரெப்சாய்டு மோசன் வரிசையில்" வைக்கப்பட்டுள்ளன: `கருவித்தொகுப்பு. படி நேரங்கள் பின்னர் உருவாக்கப்படுகின்றன: `கருவிஎட். /itersolve.c). ஒரு காலத்திலிருந்து ஒரு ச்டெப்பர் நிலையைக் கணக்கிடும் ஒரு செயல்பாட்டைக் கொடுக்கப்பட்ட படி நேரங்களைக் கண்டுபிடிப்பதே மறு செய்கை தீர்வின் குறிக்கோள். ச்டெப்பர் நிலை தேற்றம் ச்டெப்பரில் அடுத்த கட்டத்தின் விரும்பிய நிலையைத் திரும்பும் வரை பல்வேறு முறை மறுநிகழ்வு "யூகிப்பதன்" மூலம் இது செய்யப்படுகிறது. ஒவ்வொரு யூகத்திலிருந்தும் தயாரிக்கப்படும் பின்னூட்டங்கள் எதிர்கால யூகங்களை மேம்படுத்தப் பயன்படுகின்றன, இதனால் செயல்முறை விரைவாக விரும்பிய நேரத்திற்கு மாறுகிறது. கினெமாடிக் ச்டெப்பர் நிலை சூத்திரங்கள் கிளிப்பி/ செல்பர்/ கோப்பகத்தில் அமைந்துள்ளன (எ.கா., kin_cart.c, kin_corexy.c, kin_delta.c, kin_extruder.c).
* எக்ஸ்ட்ரூடர் அதன் சொந்த இயக்கவியல் வகுப்பில் கையாளப்படுகிறது என்பதை நினைவில் கொள்ளவும்: `ToolHead._process_moves() -> PrinterExtruder.move()`. Move() வகுப்பு சரியான இயக்க நேரத்தைக் குறிப்பிடுவதாலும், படி பல்ஸ்கள் குறிப்பிட்ட நேரத்துடன் மைக்ரோ-கண்ட்ரோலருக்கு அனுப்பப்படுவதாலும், எக்ஸ்ட்ரூடர் வகுப்பால் உருவாக்கப்படும் ஸ்டெப்பர் இயக்கங்கள் குறியீடு தனித்தனியாக வைக்கப்பட்டிருந்தாலும், ஹெட் இயக்கத்துடன் ஒத்திசைவில் இருக்கும்.
...
* அடுத்த முக்கிய படி, `stepcompress_flush() -> compress_bisect_add()` (klippy/chelper/stepcompress.c இல்) படிகளைச் சுருக்க வேண்டும். இந்தக் குறியீடு முந்தைய கட்டத்தில் கட்டமைக்கப்பட்ட படிநிலை நேரங்களின் பட்டியலுடன் தொடர்புடைய மைக்ரோ-கண்ட்ரோலர் "queue_step" கட்டளைகளின் தொடரை உருவாக்கிக் குறியாக்கம் செய்கிறது. இந்த "queue_step" கட்டளைகள் பின்னர் வரிசைப்படுத்தப்பட்டு, முன்னுரிமை அளிக்கப்பட்டு, மைக்ரோ-கண்ட்ரோலருக்கு அனுப்பப்படும் (stepcompress.c:steppersync மற்றும் serialqueue.c:serialqueue வழியாக).
...
* மற்ற அச்சுப்பொறி பொருள்களால் எழுப்பப்படும் "நிகழ்வுகள்" போது குறியீடு அழைக்கப்பட வேண்டுமானால், `printer.register_event_handler()` முறையைப் பயன்படுத்தி நிகழ்வு கையாளுபவர்களைப் பதிவுசெய்யவும். ஒவ்வொரு நிகழ்வு பெயரும் ஒரு சரம், மேலும் மரபுப்படி இது நிகழ்வை எழுப்பும் முக்கிய மூல தொகுதியின் பெயராகும், மேலும் நிகழும் செயலுக்கான ஒரு குறுகிய பெயருடன் (எ.கா., "klippy:connect"). ஒவ்வொரு நிகழ்வு கையாளுபவருக்கும் அனுப்பப்படும் அளவுருக்கள் கொடுக்கப்பட்ட நிகழ்வுக்குக் குறிப்பிட்டவை (விதிவிலக்கு கையாளுதல் மற்றும் செயல்படுத்தல் சூழல் போன்றவை). இரண்டு பொதுவான தொடக்க நிகழ்வுகள்:
...
* பயனரின் கட்டமைப்பில் பிழை இருந்தால், `load_config()` அல்லது "connect event" கட்டங்களின்போது அதை உயர்த்துவதை உறுதிசெய்யவும். பிழையைப் புகாரளிக்க `raise config.error("my error")` அல்லது `raise printer.config_error("my error")` ஐப் பயன்படுத்தவும்.
...
* அச்சுப்பொறி பொருள் ஒரு `get_status()` முறையை வரையறுத்தால், தொகுதி [macros](Command_Templates.md) வழியாகவும் [API Server](API_Server.md) வழியாகவும் [status information](Status_Reference.md) ஐ ஏற்றுமதி செய்ய முடியும். `get_status()` முறை முழு எண்கள், மிதவைகள், சரங்கள், பட்டியல்கள், அகராதிகள், உண்மை, தவறு அல்லது எதுவுமில்லாத சரங்கள் மற்றும் மதிப்புகளைக் கொண்ட விசைகளைக் கொண்ட பைதான் அகராதியைத் திருப்பி அனுப்ப வேண்டும். டூப்பிள்கள் (மற்றும் பெயரிடப்பட்ட டூப்பிள்கள்) பயன்படுத்தப்படலாம் (இவை API சேவையகம் வழியாக அணுகும்போது பட்டியல்களாகத் தோன்றும்). ஏற்றுமதி செய்யப்படும் பட்டியல்கள் மற்றும் அகராதிகள் "மாறாதவை" என்று கருதப்பட வேண்டும் - அவற்றின் உள்ளடக்கங்கள் மாறினால், `get_status()` இலிருந்து ஒரு புதிய பொருளைத் திருப்பி அனுப்ப வேண்டும், இல்லையெனில் API சேவையகம் அந்த மாற்றங்களைக் கண்டறியாது.
* தொகுதிக்குக் கணினி நேரம் அல்லது வெளிப்புற கோப்பு விளக்கங்களுக்கான அணுகல் தேவைப்பட்டால், உலகளாவிய "நிகழ்வு உலை" வகுப்பிற்கான அணுகலைப் பெற `printer.get_reactor()` ஐப் பயன்படுத்தவும். இந்த உலை வகுப்பு டைமர்களை திட்டமிடவும், கோப்பு விளக்கங்களில் உள்ளீட்டிற்காகக் காத்திருக்கவும், ஹோஸ்ட் குறியீட்டை "ஸ்லீப்" செய்யவும் அனுமதிக்கிறது.
...
1. பிற முறைகள். `check_move()`, `get_status()`, `get_steppers()`, `home()`, `clear_homing_state()`, மற்றும் `set_position()` முறைகளை செயல்படுத்தவும். இந்த செயல்பாடுகள் பொதுவாக இயக்கவியல் சார்ந்த சோதனைகளை வழங்கப் பயன்படுகின்றன. இருப்பினும், மேம்பாட்டின் தொடக்கத்தில் ஒருவர் இங்கே பாய்லர்-பிளேட் குறியீட்டைப் பயன்படுத்தலாம்.
1. சோதனை வழக்குகளைச் செயல்படுத்தவும். கொடுக்கப்பட்ட இயக்கவியலுக்கான முக்கியமான நிகழ்வுகளைச் சோதிக்கக்கூடிய தொடர் நகர்வுகளுடன் சி-குறியீடு கோப்பை உருவாக்கவும். இந்த சி-குறியீட்டு கோப்பை மைக்ரோ-கன்ட்ரோலர் கட்டளைகளாக மாற்றப் [பிழைத்திருத்த ஆவணங்கள்](Debugging.md) ஐப் பின்தொடரவும். மூலையில் வழக்குகளை உடற்பயிற்சி செய்வதற்கும் பின்னடைவுகளை சரிபார்க்கவும் இது பயனுள்ளதாக இருக்கும்.
...
1. [debugging document](Debugging.md) இல் விவரிக்கப்பட்டுள்ளபடி) console.py கருவியைப் பற்றி நன்கு தெரிந்துகொண்டு, அதனுடன் மைக்ரோ-கண்ட்ரோலருக்கான இணைப்பைச் சரிபார்க்கவும். இந்தக் கருவி குறைந்த-நிலை மைக்ரோ-கண்ட்ரோலர் தொடர்பு நெறிமுறையை மனிதர்கள் படிக்கக்கூடிய வடிவத்திற்கு மொழிபெயர்க்கிறது.
...
1. கூடுதல் புறச்சாதனங்களைக் கொண்டு வாருங்கள் - எடுத்துக்காட்டாக, கிளிப்பர் கமிட் [65613aed](https://github.com/Klipper3d/klipper/commit/65613aeddfb9ef86905cb1dade9e773a02ef3c27), [c812a40a](https://github.com/Klipper3d/klipper/commit/c812a40a3782415e454b04bf7bd2158a6f0ec8b5), மற்றும் [c381d03a](https://github.com/Klipper3d/klipper/commit/c381d03aad5c3ee761169b7c7bced519cc14da29) ஆகியவற்றைப் பார்க்கவும்.
...
"toolhead" நிலை (`toolhead.get_position()`) என்பது config கோப்பில் குறிப்பிடப்பட்டுள்ள ஆயத்தொலைவு அமைப்புடன் தொடர்புடைய கார்ட்டீசியன் ஆயத்தொலைவுகளில் கருவித்தலைப்பின் கடைசி கோரப்பட்ட நிலையாகும். வினவல் வழங்கப்படும்போது ரோபோ இயக்கத்தில் இருந்தால், அறிக்கையிடப்பட்ட மதிப்பில் கோரப்பட்ட அனைத்து நகர்வுகளும் அடங்கும் (ஸ்டெப்பர் மோட்டார் இயக்கிகளுக்கு வழங்கக் காத்திருக்கும் இடையகங்களில் உள்ளவை கூட).
...
* 32பிட் மற்றும் 64பிட் கடிகாரங்கள்: அலைவரிசையைக் குறைக்கவும் மைக்ரோ-கட்டுப்படுத்தி செயல்திறனை மேம்படுத்தவும், மைக்ரோ-கட்டுப்படுத்தியில் உள்ள கடிகாரங்கள் 32பிட் முழு எண்களாகக் கண்காணிக்கப்படுகின்றன. mcu குறியீட்டில் இரண்டு கடிகாரங்களை ஒப்பிடும்போது, முழு எண் ரோல்ஓவர்கள் சரியாகக் கையாளப்படுவதை உறுதிசெய்ய `timer_is_before()` செயல்பாடு எப்போதும் பயன்படுத்தப்பட வேண்டும். ஹோஸ்ட் மென்பொருள், அது பெற்ற கடைசி mcu நேர முத்திரையிலிருந்து உயர்-வரிசை பிட்களைச் சேர்ப்பதன் மூலம் 32பிட் கடிகாரங்களை 64பிட் கடிகாரங்களாக மாற்றுகிறது - mcu இலிருந்து எந்தச் செய்தியும் எதிர்காலத்திலோ அல்லது கடந்த காலத்திலோ 2^31 கடிகார டிக்களுக்கு மேல் இல்லை, எனவே இந்த மாற்றம் ஒருபோதும் தெளிவற்றதாக இருக்காது. உயர்-வரிசை பிட்களைத் துண்டிப்பதன் மூலம் ஹோஸ்ட் 64பிட் கடிகாரங்களிலிருந்து 32பிட் கடிகாரங்களாக மாற்றுகிறது. இந்த மாற்றத்தில் எந்தத் தெளிவின்மையும் இல்லை என்பதை உறுதிப்படுத்த, **klippy/chelper/serialqueue.c** குறியீடு செய்திகள் அவற்றின் இலக்கு நேரத்தின் 2^31 கடிகார டிக்களுக்குள் இருக்கும் வரை இடையகப்படுத்தும்.
